...
the `134c714b65d54a4f` in the `msg` field is a temporary public access point generated by server and is valid for 1 hour. Then `192.168.1.1:80` service can be accessed immediately through [https://134c714b65d54a4f.gost.plus](https://134c714b65d54a4f.gost.plus).
