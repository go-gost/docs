...
- __Application__ refers to GOST, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GOST.
...
- __Website__ refers to GOST, accessible from [https://gost.run](https://gost.run)
